...
static const char col_pink[]        = "#005577";
...
static const char *voldw[]  = { "pactl", "set-sink-volume", "0", "-5%", NULL };
static const char *mute[]  = { "pactl", "set-sink-mute", "0", "toggle", NULL };

/* microphone toggle */
static const char *micmute[]  = { "pactl", "set-source-mute", "alsa_input.pci-0000_05_00.6.analog-stereo", "toggle", NULL };
...
static const Key keys[] = {
	...
	{ 0,            XF86AudioLowerVolume, 	   spawn,          {.v = voldw} },
