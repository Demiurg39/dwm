...
/* tagging */
static char *tags[] = {"www", "cmd", "dev", "chat", "sys", "med"};
...
static const char *light_up[] = {"/usr/bin/brillo", "-A", "5", NULL};
static const char *light_down[] = {"/usr/bin/brillo", "-U", "5", NULL};
...
static const Key keys[] = {
    ...
    // inner gaps
    { MODKEY|ControlMask|ShiftMask,     XK_plus,    incrigaps,      {.i = +1 } },
    ...
    // restart
    { MODKEY|ControlMask|ShiftMask,     XK_r,       restart,        {0} },
